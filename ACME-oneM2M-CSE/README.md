# Para começar Mobilidade Computacional

A primeira vez que se executa o ACME tem de se instalar as depêndencias.
Para isso eu uso o anaconda porém pode instalar diretamente no ambiente de python instalado por defeito com o sistema operativo.

conda create -n onemtwom
conda activate onemtwom
python3 -m pip install -r requirements.txt
python3 -m acme

Após a execução e sucesso destes comandos podes abrir o teu browser no endereço: http://localhost:8080/
