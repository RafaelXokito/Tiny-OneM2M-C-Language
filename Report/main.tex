...
%
%Na máquina 3, tivemos de importar o source code para a máquina
%Instalar o sqlite3 já vinha por default instalado
%Fazer a compilação dos ficheiros e a solução proposta estava pronta a usar
%Dependências no executável
